...
public class LabTestActivity extends AppCompatActivity {
    ...
    private String[][] packages = {
            {"Package 1 : Full Body Checkup", "", "", "", "160"},
            {"Package 2 : Blood Glucose Fasting", "", "", "", "190"},
            {"Package 3 : Covid-19 Antibody - 1gG", "", "", "", "130"},
            {"Package 4 : Thyroid Check", "", "", "", "150"},
            {"Package 5 : Immunity Check", "", "", "", "180"}
    };
