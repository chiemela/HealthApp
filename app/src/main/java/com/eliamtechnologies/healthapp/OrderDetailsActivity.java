...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < order_details.length; i++){
            order_details[i] = new String[5];   // 5 columns because of the multi_line.xml layout
        ...
        // map each item in "order_details" to "list" ArrayList
        list = new ArrayList();
        for(int i = 0; i < order_details.length; i++){
        ...
        // add "list" ArrayList to SimpleAdapter
